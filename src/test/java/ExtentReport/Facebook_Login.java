...
import RetryFailedTestCases.Retry;

//imported Retry class to execute retry on failed test cases.
...
public class Facebook_Login extends NewTest{
  ...
  @Test(retryAnalyzer =Retry.class)//pass parameter to the testcase which you want retry 
